  ...
  return (
    <div className="min-h-screen bg-[#f7f9fd] p-4 text-[#0b1954] sm:p-6">
      ...
      <div className="mb-6 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p className="mt-1 text-[13px] text-[#40507d]">
            Configure how complaints are created, assigned, tracked and
            resolved.
          </p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-5 items-start">
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="bg-white border border-[#e8ecf5] rounded-xl overflow-hidden shadow-sm h-full  flex flex-col">
            {" "}
            <div className="px-5 py-4 border-b border-[#edf0f6]">
                      ...
                      >
                        ...
                        <td className="px-4 py-4">
                          {isEditing ? (
                            ...
                            <span
                              className={`${item.badge} px-2 py-1 rounded text-[10px]`}
                            >
                              {item.name}
                            </span>
                          )}
          ...
          <div className="grid grid-cols-1 2xl:grid-cols-2 gap-5 items-stretch">
                  ...
                  <tbody>
                    {assignmentData.map(([category, person], index) => {
                      ...
                      return (
                        <tr
                          key={category}
                          className="border-b border-[#edf0f6]"
                        >
                          {/* CATEGORY */}
                          ...
                          <td className="px-3 py-3">
                            {isEditing ? (
                              ...
                              <span className="text-[11px] text-[#263765]">
                                {person}
                              </span>
                            )}
                          </td>
            ...
            <div className="bg-white border border-[#e8ecf5] rounded-xl overflow-hidden shadow-sm h-full flex flex-col">
              ...
              <div className="p-3 space-y-2 flex-1">
                <CheckRow
                  label="Allow attachments in complaints"
                  field="attachments"
                />
                ...
                <CheckRow
                  label="Allow residents to edit complaints"
                  field="residentsEdit"
                />
                <CheckRow
                ...
                />
                <CheckRow
                  label="Limit number of complaints per day"
                  field="limitComplaints"
                />
                ...
                <CheckRow
                  label="Show complaint history to residents"
                  field="history"
                />
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="bi bi-lightning-charge-fill">
                      Electricity
                    </option>
      ...
      <DeletePopup
        ...
        onCancel={() => setDeletePriority(null)}
        onConfirm={() => {
      ...
      <DeletePopup
        ...
        onConfirm={() => {
          setAssignmentData((prev) =>
            prev.filter((_, index) => index !== deleteAssignment.index),
          );
