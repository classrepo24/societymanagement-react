      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="bg-white rounded-2xl border border-[#e5e7eb] p-6">
            ...
            <div className="mt-5">
              ...
              <input
                ...
                className={`w-full mt-2 h-12 rounded-lg px-4 outline-none border ${
                  errors.title ? "border-red-500" : "border-[#dbe2ef]"
                }`}
              />
            ...
            <div className="flex items-center gap-3 mt-8 mb-5">
              ...
              <h3 className="font-semibold text-[#0f172a]">Location Details</h3>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              <div>
                <label className="text-sm font-medium">Flat / Unit *</label>
                ...
                {errors.flat && (
                  <p className="text-red-500 text-xs mt-1">{errors.flat}</p>
                )}
              </div>
        ...
        <div className="lg:col-span-3 space-y-6">
          <div className="bg-white border border-[#e5e7eb] rounded-2xl p-6">
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <p className="font-medium text-sm">Add photos or documents</p>
              ...
              <div className="flex gap-3">
                ...
                <div>
                  <p className="font-medium text-sm">Track your complaint</p>
          ...
          <div className="bg-white border border-[#e5e7eb] rounded-2xl p-6">
            ...
            <p className="font-semibold">Security / Maintenance Team</p>

            <p className="text-[#2563eb] font-bold mt-3">+91 121212121212</p>

            <p className="text-sm text-[#64748b] mt-4">Available 24 x 7</p>
          </div>
        </div>
      </div>
    </div>
