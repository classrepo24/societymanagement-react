        ...
        <div className="flex-1 flex flex-col">
          <div className="space-y-4 w-full max-w-[90%]">
            ...
            <div>
              ...
              <div className="relative">
                <i className="bi bi-alipay absolute left-4 top-1/2 -translate-y-1/2 text-gray-500"></i>

                <select className="w-full border border-gray-300 rounded-lg pl-12 p-3 focus:outline-none focus:ring-2 focus:ring-blue-500">
