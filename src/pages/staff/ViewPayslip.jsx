...
const ViewPayslip = () => {
  ...
  const handleLoadMore = () => {
    setVisiblePeriods((prev) =>
      Math.min(prev + 3, periods.length)
    );
  };
    ...
    <div className="p-6 bg-[#F8FAFF] min-h-screen">
      ...
      <div ref={payslipRef}>
          ...
          <div className="grid grid-cols-6 gap-5 items-center">
            ...
            <div className=" col-span-2 flex items-center gap-4">
              ...
              <div>
                ...
                <p className="flex items-center gap-1 whitespace-nowrap text-gray-500">
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          {!isDownloading && (
            ...
            <div className="col-span-4">
              ...
              <div className="bg-white border rounded-xl p-5">
                ...
                <div className="space-y-2 max-h-[590px] overflow-y-auto pr-2">
                  {periods.slice(0, visiblePeriods).map((item, index) => (
                    <div
                      key={index}
                      className={`flex justify-between items-center p-4 rounded-xl  cursor-pointer transition ${item.active
                ...
                {visiblePeriods < periods.length && (
                  <button
                    ...
                    className="w-full mt-6 border rounded-lg py-3 font-semibold text-[#0B1F66] hover:bg-gray-50"
                  >
                    Load More
          ...
          <div className={isDownloading ? "col-span-12" : "col-span-8"}>
            <div
              ...
              <div className="flex justify-between items-center mb-6">
                ...
                {!isDownloading && (
                  <div className="flex gap-3">
                    ...
                    <button
                      onClick={() =>
                        navigate(`/staff/profile/salary-payroll/view-payslip/viewpayslip-pdf/${employee.id}`)
                      }
              ...
              <div className="mt-14 bg-indigo-50 rounded-lg px-5 py-4 text-[#0B1F66] flex items-center gap-3">
